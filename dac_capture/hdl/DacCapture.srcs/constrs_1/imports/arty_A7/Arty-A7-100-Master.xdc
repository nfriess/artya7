...
## Pmod Header JD
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { dac_wordclk }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { jd[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { dac_bitclk }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { dac_data }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
...
set_property -dict { PACKAGE_PIN C1    IOSTANDARD LVCMOS33 } [get_ports { spi_ce }]; #IO_L16N_T2_35 Sch=ck_ss
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {spi_clk_IBUF}];
create_clock -add -name spi_clk_pin -period 62.5 -waveform {0 31.25} [get_ports { spi_clk }];
